...
class SignosVitales(models.Model):
    ...
    oximetria = models.DecimalField('Oximetria', max_digits = 10, decimal_places = 3)
    ...
    temperatura = models.DecimalField('Temperatura', max_digits = 10, decimal_places = 3)
    presionArterial = models.IntegerField('Presion Arterial')
    glicemia = models.DecimalField('Glicemia', max_digits = 10, decimal_places = 3)
